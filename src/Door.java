...
public class Door extends OverworldTile {
    ...
    public Door(int x, int y, boolean walkable, int tileSize, String tileName, String doorPath, int newX, int newY, String neededItem) {
    ...
    public void checkCollisions(Rectangle playerBounds, OverworldPlayer player, GameManager game, HashMap<String, Integer> inventory) {
        if ((playerBounds.intersects(this.getBoundingBox())) && (inventory.containsKey(this.neededItem))) {
