...
/**
 * [FirstInRowAbility]
 * An ability that targets the first entity in a row, from left or right side first
 * @version 1.0
 * @author Allen Liu
 * @since June 10, 2019
 */
public class FirstInRowAbility extends Ability {
     ...
     */
    FirstInRowAbility(AnimatedSprite animation, String name, String desc, double energyCost, int cooldown, int xRange, int yRange, double baseDamage, double damageRatio, boolean enemyTarget, boolean friendTarget) {
        super(animation, name, desc, energyCost, cooldown, xRange, yRange, baseDamage, damageRatio, enemyTarget, friendTarget);
    }
